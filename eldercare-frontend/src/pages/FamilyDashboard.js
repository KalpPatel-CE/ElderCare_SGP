    ...
    return (
      <div className="app-container">
        ...
        <div className="main-content">
          <TopNavbar title="Family Dashboard" />
      ...
      <div className="main-content">
        ...
        <div className="dashboard-content">
          <div className="dashboard-header">
            ...
            <p className="dashboard-subtitle">Monitor your loved ones' health and activities</p>
          </div>

          <div className="stats-grid">
            <StatsCard label="Total Elders" value={elders.length} color="#2563eb" />
          ...
          <div>
            <h3 className="card-title" style={{ marginBottom: '20px' }}>👥 My Elders</h3>
            {elders.length === 0 ? (
              <div className="card">
